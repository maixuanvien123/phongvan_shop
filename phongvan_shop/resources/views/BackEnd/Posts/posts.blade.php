            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="main__title">
                        ...
                        <span class="main__title-stat">Tổng {{ $posts->count() }}</span>

                        <div class="main__title-wrap">
                            <!-- filter sort -->
                            <div class="filter">
                                @can('add-post')
                                <a href="{{ route('baiviet.create') }}" class="main__table-btn main__table-btn--edit">
                ...
                <div class="col-12">
                            ...
                            <table class="main__table">
                                ...
                                <tbody>
                                    @foreach ($posts as $value)
                                        <tr>
                                            <td>
                                                <div class="main__table-text">BV{{ $value->id }}</div>
                                            </td>
                                            <td>
                                                <div class="main__table-text">
                                                    <img src="{{ asset('uploads/baiviet/' . $value->image) }}" width="150"
                                                        height="100">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="main__table-btns">
                                                    @can('edit-post')
                                                        <a href="{{ route('baiviet.show', $value->id) }}"
                                                    ...
                                                    @can('delete-post')
                                                        <a href="#modal-delete"
                                                            onclick="ModalDel('{{ $value->id }}','{{ $value->name }}','{{ route('baiviet.destroy',$value->id) }}')"
                    ...
                    <!-- paginator -->
                    <div class="col-12">
                        {!! $posts->render('BackEnd.inc.paginator') !!}
                    </div>
                </div>
                <!-- end paginator -->
            </div>
