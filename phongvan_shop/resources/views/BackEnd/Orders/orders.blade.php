        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12">
                            ...
                            <table class="main__table">
                                ...
                                <tbody>
                                    @foreach ($order as $key => $value)
                                        <tr>
                                            <td>
                                                <div class="main__table-text">DH{{ $key + 1 }}</div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="main__table-btns">
                                                    @can('pdf-order')
                                                    <a href="{{ route('donhang.show', $value->id) }}" target="_bank"
                                                    ...
                                                    @endcan
                                                    @can('edit-order')
                                                    <a href="{{ route('donhang.edit', $value->id) }}"
                    ...
                    <!-- paginator -->
                    <div class="col-12">
                        {!! $order->render('BackEnd.inc.paginator') !!}
                    </div>
                </div>
                <!-- end paginator -->
            </div>
