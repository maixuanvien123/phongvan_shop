        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="main__title">
                        ...
                        <div class="main__title-wrap">
                            ...
                            <div class="filter">
                                @can('add-type')
                                <a href="{{ route('loaibaiviet.create') }}" class="main__table-btn main__table-btn--edit">
                ...
                <div class="col-12">
                            ...
                            <table class="main__table">
                                ...
                                <tbody>
                                    @foreach ($types as $value)
                                        <tr>
                                            <td>
                                                <div class="main__table-text">LBV{{ $value->id }}</div>
                                            </td>
                                            <td>
                                                <div class="main__table-text">{{ $value->name }}</div>
                                            </td>
                                            <td>
                                                <div class="main__table-text main__table-text--{{ $value->status == 0 ? 'green' : 'red' }}">{{ $value->status == 0 ? 'Hiện' : 'Ẩn' }}</div>
                                            </td>
                                            <td>
                                                <div class="main__table-btns">
                                                    @can('edit-type')
                                                    <a href="{{ route('loaibaiviet.show', $value->id) }}"
                                                    ...
                                                    @can('delete-type')
                                                    <a href="#modal-delete"
                                                        onclick="ModalDel('{{ $value->id }}','{{ $value->name }}','{{ route('loaibaiviet.destroy',$value->id) }}')"
                    ...
                    <!-- paginator -->
                    <div class="col-12">
                        {!! $types->render('BackEnd.inc.paginator') !!}
                    </div>
                </div>
                <!-- end paginator -->
            </div>
